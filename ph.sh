...
banner() {
	cat <<- EOF
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} my website https://alhelfi.softr.app${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
		...
		${BLUE}  
		${BLUE}  
		${BLUE}  ${WHITE} My website : https://alhelfi.softrr.app
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}mohammed ali ${RED}[ ${ORANGE}alhelfi${RED}]
		${GREEN}website   ${RED}:  ${CYAN}https://alhelfi.softr.app
		${GREEN}instagram  ${RED}:  ${ORANGE}hh__y
...
main_menu() {
	{ clear; banner; echo; }
	cat <<- EOF
		${RED}[${WHITE}::${RED}]${ORANGE}select what you need${RED}[${WHITE}::${RED}]${ORANGE}

		${ORANGE}[${WHITE}01${ORANGE}]${RED} Facebook      ${ORANGE}[${WHITE}11${ORANGE}]${RED} Twitch       ${ORANGE}[${WHITE}21${REDORANGE}]${RED} DeviantArt
		${ORANGE}[${WHITE}02${ORANGE}]${RED} Instagram     ${ORANGE}[${WHITE}12${ORANGE}]${RED} Pinterest    ${ORANGE}[${WHITE}22${ORANGE}]${RED} Badoo
		${ORANGE}[${WHITE}03${ORANGE}]${RED} Google        ${ORANGE}[${WHITE}13${ORANGE}]${RED} Snapchat     ${ORANGE}[${WHITE}23${ORANGE}]${RED} Origin
		${ORANGE}[${WHITE}04${ORANGE}]${RED} Microsoft     ${ORANGE}[${WHITE}14${ORANGE}]${RED} Linkedin     ${ORANGE}[${WHITE}24${ORANGE}]${RED} DropBox	
		${ORANGE}[${WHITE}05${ORANGE}]${RED} Netflix       ${ORANGE}[${WHITE}15${ORANGE}]${RED} Ebay         ${ORANGE}[${WHITE}25${ORANGE}]${RED} Yahoo		
		${ORANGE}[${WHITE}06${ORANGE}]${RED} Paypal        ${ORANGE}[${WHITE}16${ORANGE}]${RED} Quora        ${ORANGE}[${WHITE}26${ORANGE}]${RED} Wordpress
		${ORANGE}[${WHITE}07${ORANGE}]${RED} Steam         ${ORANGE}[${WHITE}17${ORANGE}]${RED} Protonmail   ${ORANGE}[${WHITE}27${ORANGE}]${RED} Yandex			
		${ORANGE}[${WHITE}08${ORANGE}]${RED} Twitter       ${ORANGE}[${WHITE}18${ORANGE}]${RED} Spotify      ${ORANGE}[${WHITE}28${ORANGE}]${RED} StackoverFlow
		${ORANGE}[${WHITE}09${ORANGE}]${RED} Playstation   ${ORANGE}[${WHITE}19${ORANGE}]${RED} Reddit       ${ORANGE}[${WHITE}29${ORANGE}]${RED} Vk
		${ORANGE}[${WHITE}10${ORANGE}]${RED} Tiktok        ${ORANGE}[${WHITE}20${ORANGE}]${RED} Adobe        ${ORANGE}[${WHITE}30${ORANGE}]${RED} XBOX
		${ORANGE}[${WHITE}31${ORANGE}]${RED} Mediafire     ${ORANGE}[${WHITE}32${ORANGE}]${RED} Gitlab       ${ORANGE}[${WHITE}33${ORANGE}]${RED} Github
		${ORANGE}[${WHITE}34${ORANGE}]${RED} Discord
